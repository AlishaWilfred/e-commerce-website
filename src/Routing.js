...
export default function Routing({cartItem,setCartItem,addToCart,removeCartItem,
    decreaseCartitem,products,setProducts,addToWishlist,wishlist,setWishlist}) {
  return (
   <>
    <Routes>
        <Route  path="/" element={<Home addToCart={addToCart} setCartItem={setCartItem} cartItem={cartItem} products={products} setProducts={setProducts}/>}/>
